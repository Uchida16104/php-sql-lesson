...
SELECT category_id,avg(price) AS 'avggoods'　FROM　product　GROUP BY　category_id;
SELECT category_id,count(price) AS 'countprice'　FROM　product　GROUP BY　category_id;
SELECT category_id,sum(price) AS 'sumprice'　FROM　product　GROUP BY　category_id;
SELECT category_id,max(price) AS 'maxprice'　FROM　product　GROUP BY　category_id;
SELECT category_id,min(price) AS 'minprice'　FROM　product　GROUP BY　category_id;
