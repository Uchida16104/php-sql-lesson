    ...
    function judge03($random01, $random02)
    {
        if (
            ...
            print $blank .
                ...
                "." .
                $blank .
                "random02 is larger than random01." .
                $blank .
                "One of them is multiple of 3." .
                $blank;
        elseif (
            $random01 == $random02 &&
            $random01 % 3 == 0 &&
...
?>
    ...
    <form method="post">
        <input type="radio" name="music_genre" value="select" <?php if (
            $music_genre === "select"
        ) {
            echo "checked";
        } ?> checked>select
        <input type="radio" name="music_genre" value="electronic" <?php if (
            $music_genre === "electronic"
        ) {
            echo "checked";
        } ?>>electronic
        <input type="radio" name="music_genre" value="techno" <?php if (
            $music_genre === "techno"
        ) {
            echo "checked";
        } ?>>techno
        <input type="radio" name="music_genre" value="ambient" <?php if (
            $music_genre === "ambient"
        ) {
            echo "checked";
        } ?>>ambient
        <input type="radio" name="music_genre" value="orchestral" <?php if (
            $music_genre === "orchestral"
        ) {
            echo "checked";
        } ?>>orchestral
        <input type="radio" name="music_genre" value="others" <?php if (
            $music_genre === "others"
        ) {
            echo "checked";
        } ?>>others
